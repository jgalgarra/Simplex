...
Since the data correspond to natural communities where we have a few very 
abundant species and a large number of rare species, the logarithm will 
be applied to all the variables corresponding to species. In this way we
will check if, by smoothing out these differences, we are able to improve 
...
print("Predictor with environmental and log tranformation of competition data")
print("=================================================")
...
individuals_train[['individuals', 'BEMA', 'CETE', 'CHFU', 'CHMI', 'COSQ', 'FRPU', 'HOMA', 'LEMA', 'LYTR',
        'MEEL', 'MEPO', 'MESU', 'PAIN', 'PLCO', 'POMA', 'POMO', 'PUPA', 'RAPE',
        'SASO', 'SCLA', 'SOAS', 'SPRU', 'SUSP']] = individuals_train[['individuals', 'BEMA', 'CETE', 'CHFU', 'CHMI', 'COSQ', 'FRPU', 'HOMA', 'LEMA', 'LYTR',
        'MEEL', 'MEPO', 'MESU', 'PAIN', 'PLCO', 'POMA', 'POMO', 'PUPA', 'RAPE',
        'SASO', 'SCLA', 'SOAS', 'SPRU', 'SUSP']].applymap(lambda x: np.log(1 + x))
...
predictions_lr = np.exp(predictions_lr) - 1
...
predictions_rf = np.exp(predictions_rf) - 1    
...
predictions_xgb = np.exp(predictions_xgb) - 1
